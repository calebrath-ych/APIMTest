...
{
    public class GetKilnSampleReport : ApiFunction
    {
        private IGrowerPortalService growerPortalService;
        private IValidationService validation;

        public GetKilnSampleReport(IGrowerPortalService growerPortalService, IValidationService validation,
        ...
        [Function(nameof(GetKilnSampleReport))]
        public async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "kiln-sample-reports")]
            HttpRequest req)
        {
            return await ProcessRequest(req, async () =>
            {
                ...
                return SuccessResponse(await growerPortalService.GetKilnSampleReports(year));
            });
        }
    }
}